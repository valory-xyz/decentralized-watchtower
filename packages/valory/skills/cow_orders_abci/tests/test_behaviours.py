...
class TestRandomnessBehaviour(BaseCowOrdersTest):
    """Tests RandomnessBehaviour"""

    # TODO: set next_behaviour_class
    behaviour_class: Type[BaseBehaviour] = RandomnessBehaviour
    next_behaviour_class: Type[BaseBehaviour] = ...
...
class TestSelectKeeperBehaviour(BaseCowOrdersTest):
