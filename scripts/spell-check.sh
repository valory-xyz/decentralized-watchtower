...
if [ -z "${MDSPELL_PATH}" ]; then
  ...
  mdspell -r -n -a --en-gb '**/*.md' '!docker-images/*.md' '!docs/api/**/*.md' '!third_party/**/*.md' '!go-ipfs/**/*.md' '!docs/package_list.md' --ignored packages/fetchai/connections/http_server/README.md
fi
